...
import net.corda.node.services.persistence.SecureHashConverter
...
class KotlinConfigurationTransactionWrapper(private val model: EntityModel,
    ...
    override fun getMapping(): Mapping? {
        ...
        val secureHashConverter = SecureHashConverter()
        customMapping.addConverter(secureHashConverter, secureHashConverter.mappedType)
