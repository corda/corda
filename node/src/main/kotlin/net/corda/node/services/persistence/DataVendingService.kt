 ...
 */
class DataVendingPlugin : CordaPluginRegistry()  {
    override fun initialise(serviceHub: PluginServiceHub) {
        serviceHub.registerFlowInitiator(FetchTransactionsFlow::class.java, ::FetchTransactionsHandler)
        serviceHub.registerFlowInitiator(FetchAttachmentsFlow::class.java, ::FetchAttachmentsHandler)
        serviceHub.registerFlowInitiator(BroadcastTransactionFlow::class.java, ::NotifyTransactionHandler)
    }
