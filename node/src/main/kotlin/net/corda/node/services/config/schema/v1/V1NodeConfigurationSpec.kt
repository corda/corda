...
internal object V1NodeConfigurationSpec : Configuration.Specification<NodeConfiguration>("NodeConfiguration") {
    ...
    private val networkParameterAcceptanceSettings by nested(NetworkParameterAcceptanceSettingsSpec).optional().withDefaultValue(Defaults.networkParameterAcceptanceSettings)
    @Suppress("unused")
