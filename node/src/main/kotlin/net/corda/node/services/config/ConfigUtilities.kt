...
import net.corda.node.internal.certificates.CertificateSource
...
fun SSLConfiguration.configureDevKeyAndTrustStores(myLegalName: CordaX500Name) {
    ...
    if (!sslKeystore.exists() || !nodeKeystore.exists()) {
        createKeystoreForCordaNode(sslKeystore, nodeKeystore, keyStorePassword, keyStorePassword, devCAKeys, "cordacadevkeypass", myLegalName)
...
fun createKeystoreForCordaNode(sslKeyStorePath: Path,
    ...
    val (intermediateCACert, intermediateCAKeyPair) = caKeyStore.getCordaIntermediateCertificateAndKeyPair(caKeyPassword)
