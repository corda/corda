...
// TODO Move this to KeyStoreConfigHelpers
// TODO sollecitom refactor
fun Pair<NodeSSLConfiguration, SSLConfiguration>.configureDevKeyAndTrustStores(myLegalName: CordaX500Name) {
    ...
    if (!second.sslKeystore.exists() || !first.nodeKeystore.exists()) {
