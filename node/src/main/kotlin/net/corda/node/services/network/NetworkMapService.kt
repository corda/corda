...
interface NetworkMapService {
    ...
    data class QueryIdentityRequest(val identity: PartyAndCertificate<Party>,
                                    override val replyTo: SingleMessageRecipient,
                                    override val sessionID: Long = random63BitValue()) : ServiceRequestMessage
...
class InMemoryNetworkMapService(services: ServiceHubInternal, minimumPlatformVersion: Int)
    ...
    override val nodeRegistrations: MutableMap<PartyAndCertificate<Party>, NodeRegistrationInfo> = ConcurrentHashMap()
...
abstract class AbstractNetworkMapService(services: ServiceHubInternal,
    ...
    protected abstract val nodeRegistrations: MutableMap<PartyAndCertificate<Party>, NodeRegistrationInfo>
