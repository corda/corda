    ...
    open protected fun <K, V> configuredForNamed(caffeine: Caffeine<K, V>, name: String): Caffeine<K, V> {
        return with(nodeConfiguration!!) {
            when {
                ...
                name == "AttachmentsClassLoader_cache" -> caffeine.maximumSize(DEFAULT_ATTACHMENTS_CLASSLOADER_CACHE_SIZE)
...
private const val DEFAULT_ATTACHMENTS_CLASSLOADER_CACHE_SIZE = 256L