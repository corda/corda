...
abstract class AbstractNode(open val configuration: NodeConfiguration,
    ...
    private fun makeInfo(legalIdentity: PartyAndCertificate): NodeInfo {
        ...
        val notaryIdentity = getNotaryEntry()
     ...
     */
    protected open fun getNotaryEntry(): PartyAndCertificate? {
    ...
    protected open fun makeIdentityService(trustRoot: X509Certificate,
        ...
        services.networkMapCache.allNodeInfos().forEach { it.legalIdentitiesAndCerts.forEach { service.verifyAndRegisterIdentity(it) } }
