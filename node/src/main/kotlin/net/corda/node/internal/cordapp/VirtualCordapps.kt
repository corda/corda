...
internal object VirtualCordapp {
    ...
    fun generateCoreCordapp(versionInfo: VersionInfo): CordappImpl {
        return CordappImpl(
                ...
                customSchemas = setOf(),
                info = Default("corda-core", versionInfo.vendor, versionInfo.releaseVersion, 1, versionInfo.platformVersion),
                allFlows = listOf(),
    ...
    fun generateSimpleNotaryCordapp(versionInfo: VersionInfo): CordappImpl {
        return CordappImpl(
                ...
                info = Default("corda-notary", versionInfo.vendor, versionInfo.releaseVersion, 1, versionInfo.platformVersion),
                allFlows = listOf(),
