...
// As the default notary service, JPANotaryService is being used in these tests.
abstract class AbstractNotaryServiceTests {
    ...
    fun setup() {
        mockNet = InternalMockNetwork(
                ...
                notarySpecs = listOf(MockNetworkNotarySpec(DUMMY_NOTARY_NAME, validating = isValidating()))
        )
