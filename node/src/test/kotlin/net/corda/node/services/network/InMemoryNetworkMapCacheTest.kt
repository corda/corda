...
class InMemoryNetworkMapCacheTest {
    ...
    fun `key collision`() {
        ...
        val nodeA = network.createNode(null, -1, MockNetwork.DefaultFactory, true, DUMMY_BANK_A.name, null, entropy, ServiceInfo(NetworkMapService.type))
        val nodeB = network.createNode(null, -1, MockNetwork.DefaultFactory, true, DUMMY_BANK_B.name, null, entropy, ServiceInfo(NetworkMapService.type))
