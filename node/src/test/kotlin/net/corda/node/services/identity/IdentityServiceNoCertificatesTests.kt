...
//
//        assertThat(identityService.registerConfidentialIdentityMapping(alice, key)).isTrue()
//        assertThat(identityService.registerConfidentialIdentityMapping(alice, key1)).isTrue()
//        assertThat(identityService.registerConfidentialIdentityMapping(bob, key1)).isFalse()
//        assertThat(identityService.registerConfidentialIdentityMapping(bob, key2)).isTrue()
//        database.close()
//    }
//
//    @Test
...
//
//        assertThat(inMemoryIdentityService.registerConfidentialIdentityMapping(alice, key)).isFalse()
//        assertThat(inMemoryIdentityService.registerConfidentialIdentityMapping(alice, key1)).isTrue()
//        assertThat(inMemoryIdentityService.registerConfidentialIdentityMapping(bob, key1)).isFalse()
//        assertThat(inMemoryIdentityService.registerConfidentialIdentityMapping(bob, key2)).isTrue()
//    }
//
//    @Test
//    fun `Method testing`() {
