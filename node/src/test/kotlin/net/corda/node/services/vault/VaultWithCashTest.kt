    ...
    fun `issue and spend total correctly and irrelevant ignored`() {
        ...
        val spendTX =
            database.transaction {
                ...
                generateSpend(services, spendTXBuilder, 80.DOLLARS, BOB)
        ...
        backgroundExecutor.submit {
            database.transaction {
                try {
                    ...
                    generateSpend(services, txn1Builder, 60.DOLLARS, BOB)
        ...
        backgroundExecutor.submit {
            database.transaction {
                try {
                    ...
                    generateSpend(services, txn2Builder, 80.DOLLARS, BOB)
