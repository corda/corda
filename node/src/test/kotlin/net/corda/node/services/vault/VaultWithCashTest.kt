    ...
    fun `issue and spend total correctly and irrelevant ignored`() {
        ...
        val spendTX =
            database.transaction {
                ...
                Cash.generateSpend(services, spendTXBuilder, 80.DOLLARS, services.myInfo.chooseIdentityAndCert(), BOB)
        ...
        backgroundExecutor.submit {
            database.transaction {
                try {
                    ...
                    Cash.generateSpend(services, txn1Builder, 60.DOLLARS, services.myInfo.chooseIdentityAndCert(), BOB)
        ...
        backgroundExecutor.submit {
            database.transaction {
                try {
                    ...
                    Cash.generateSpend(services, txn2Builder, 80.DOLLARS, services.myInfo.chooseIdentityAndCert(), BOB)
