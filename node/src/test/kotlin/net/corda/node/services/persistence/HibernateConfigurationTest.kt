    ...
    fun setUp() {
        ...
        database.transaction {
            ...
            services = object : MockServices(cordappPackages, BOB_NAME, mock<IdentityService>().also {
                ...
                override val vaultService = NodeVaultService(Clock.systemUTC(), keyManagementService, servicesForResolution, database, schemaService, TestingNamedCacheFactory(), cordappClassloader).apply { start() }
