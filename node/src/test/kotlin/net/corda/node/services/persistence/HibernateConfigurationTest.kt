    ...
    fun setUp() {
        ...
        database.transaction {
            ...
            services = object : MockServices(cordappPackages, BOB_NAME, mock<IdentityServiceInternal>().also {
                ...
                override val vaultService = NodeVaultService(Clock.systemUTC(), keyManagementService, servicesForResolution, database, schemaService, getCordappClassloader()).apply { start() }
