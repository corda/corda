...
class CompositeKeyTests {
    ...
    fun `Test save to keystore`() {
        ...
        val compositeKeyCert = X509Utilities.createCertificate(CertificateType.WELL_KNOWN_LEGAL_IDENTITY, ca, caKeyPair, caName.copy(commonName = "CompositeKey"), compositeKey)
