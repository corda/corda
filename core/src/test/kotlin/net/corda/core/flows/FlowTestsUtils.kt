 ...
 */
inline fun <I : FlowLogic<*>, reified R : FlowLogic<*>> MockNode.registerInitiatedFlow(initiatingFlowType: KClass<I>, crossinline construct: (session: FlowSession) -> R) {
 ...
 */
inline fun <I : FlowLogic<*>, reified R : Any> MockNode.registerAnswer(initiatingFlowType: KClass<I>, value: R) {
