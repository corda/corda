 ...
 */
inline fun <I : FlowLogic<*>, reified R : FlowLogic<*>> StartedMockNode.registerInitiatedFlow(initiatingFlowType: KClass<I>, crossinline construct: (session: FlowSession) -> R) {
 ...
 */
inline fun <I : FlowLogic<*>, reified R : Any> StartedMockNode.registerAnswer(initiatingFlowType: KClass<I>, value: R) {
