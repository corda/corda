 ...
 */
@InitiatingFlow
open class NotarisationFlow(private val stx: SignedTransaction,
                            override val progressTracker: ProgressTracker) : FlowLogic<List<DigitalSignature.WithKey>>() {
    constructor(stx: SignedTransaction) : this(stx, NotarisationFlow.tracker())
...
abstract class NotarisationHandler(val otherSide: Party, val service: TrustedAuthorityNotaryService) : FlowLogic<Void?>() {
