...
import net.corda.core.crypto.internal.CrossProviderKeyRotationProofUtils
...
interface TransactionWithSignatures : NamedByHash {
    ...
    fun getMissingSigners(): Set<PublicKey> {
        val sigKeys = sigs.mapToSet { it.by } + CrossProviderKeyRotationProofUtils.extractPreviousIdentityKeys(sigs)
