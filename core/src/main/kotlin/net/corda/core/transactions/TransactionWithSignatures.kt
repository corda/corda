...
import net.corda.core.crypto.internal.keyrotation.crossprovider.KeyRotationProofExtractor
...
interface TransactionWithSignatures : NamedByHash {
    ...
    fun getMissingSigners(): Set<PublicKey> {
        val sigKeys = sigs.mapToSet { it.by } + KeyRotationProofExtractor.extractPreviousIdentityKeys(sigs)
