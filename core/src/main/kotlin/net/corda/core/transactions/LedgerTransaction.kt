...
private constructor(
    ...
    internal fun internalPrepareVerify(extraAttachments: List<Attachment>): Verifier {
        ...
        return AttachmentsClassLoaderBuilder.withAttachmentsClassloaderContext(this.attachments + extraAttachments, getParamsWithGoo(), id, whitelistedKeys = whitelistedKeysForAttachments) { transactionClassLoader ->
