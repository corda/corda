 ...
 */
inline fun <reified T : Any> ByteSequence.checkpointDeserialize(context: CheckpointSerializationContext): T {
 ...
 */
inline fun <reified T : Any> SerializedBytes<T>.checkpointDeserialize(context: CheckpointSerializationContext): T {
    return effectiveSerializationEnv.checkpointSerializer.deserialize(this, T::class.java, context)
}
 ...
 */
inline fun <reified T : Any> ByteArray.checkpointDeserialize(context: CheckpointSerializationContext): T {
 ...
 */
fun <T : Any> T.checkpointSerialize(context: CheckpointSerializationContext): SerializedBytes<T> {
