...
data class SignatureMetadata(
        ...
        val applicationMetadata: ApplicationSignatureMetadata?) {

    constructor(platformVersion: Int, schemeNumberID: Int)
            : this(platformVersion, schemeNumberID, null)
}

@CordaSerializable
sealed class ApplicationSignatureMetadata {
    data class AttesterCertificateHolder(val data: AttesterCertificate): ApplicationSignatureMetadata()
}
