...
/**
 * Same as [Future] with additional methods to provide some of the features of [CompletableFuture] while minimising the
 * API surface area.
 * In Kotlin, to avoid compile errors, whenever CordaFuture is used in a parameter or extension method receiver type, its
 * type parameter should be specified with out variance.
 */
