...
import net.corda.core.internal.context.DurableStreamContext
...
data class InvocationContext(
    ...
    companion object {
        ...
        fun newInstance(
            ...
            durableStreamContext: DurableStreamContext? = null
        ) = InvocationContext(origin, trace, actor, externalTrace, impersonatedActor, arguments, clientId, durableStreamContext)
        ...
        fun rpc(
            ...
            arguments: List<Any?> = emptyList(),
            durableStreamContext: DurableStreamContext? = null
        ): InvocationContext = newInstance(InvocationOrigin.RPC(actor), trace, actor, externalTrace, impersonatedActor, arguments, null, durableStreamContext)
