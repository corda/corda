 ...
 * @property contract The contract name contained within the JAR - for backward compatibility
 * @property contracts Additional contract names contained within the JAR
 */
@CordaSerializable
