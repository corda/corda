 ...
 * [FlowExternalAsyncOperation.execute] has completed. Examples of external processes where [FlowExternalAsyncOperation] would be useful include,
 ...
 *
 * Implementations of [FlowExternalAsyncOperation] should ideally hold references to any external values required by [execute]. These references
 ...
 *
 * It is discouraged to insert into the node's database from a [FlowExternalAsyncOperation], except for keeping track of [deduplicationId]s that
 * have been processed. It is possible to interact with the database from inside a [FlowExternalAsyncOperation] but, for most operations, is not
 * currently supported.
 */
 ...
 * has been retrieved. Examples of external processes where [FlowExternalOperation] would be useful include, triggering a long running process
