...
class CashSelectionPostgreSQLImpl : CashSelection {
            ...
            spendLock.withLock {
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        val stateBlob = rs.getBlob(3)
                        // TODO: deserialize blob directly
                        val blobLength = stateBlob.length()
                        val blobAsBytes = stateBlob.getBytes(1, blobLength.toInt())
                        stateBlob.free()
                        val state = blobAsBytes.deserialize<TransactionState<Cash.State>>(context = SerializationDefaults.STORAGE_CONTEXT)
