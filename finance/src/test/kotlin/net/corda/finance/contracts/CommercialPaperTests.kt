...
class CommercialPaperTestsGeneric {
    ...
    private val issuerServices = MockServices(setOf("net.corda.finance.contracts"), rigorousMock(), MEGA_CORP.name, DUMMY_CASH_ISSUER_KEY)
    ...
    fun `issue move and then redeem`() {
        val aliceDatabaseAndServices = makeTestDatabaseAndMockServices(
                ...
                setOf("net.corda.finance.contracts"),
                MEGA_CORP.name)
