...
val DUMMY_NOTARY_IDENTITY: VerifiedParty get() = getTestVerifedParty(DUMMY_NOTARY)
...
val ALICE_IDENTITY: VerifiedParty get() = getTestVerifedParty(ALICE)
...
/** Dummy individual identity for tests and simulations */
val BOB_IDENTITY: VerifiedParty get() = getTestVerifedParty(BOB)
...
val DUMMY_IDENTITY_1: VerifiedParty get() = getTestVerifedParty(DUMMY_PARTY)
