...
internal class RefState : Contract {
    companion object {
        val CONTRACT_ID = "net.corda.groups.flows.RefState"
    }
...
class WithReferencedStatesFlowTests {
    companion object {
        ...
        private val mockNet = InternalMockNetwork(
                cordappsForAllNodes = cordappsForPackages("net.corda.groups", "net.corda.testing.contracts"),
                threadPerNode = true,
    ...
    fun test() {
        ...
        nodes[1].services.startFlow(ReferenceDataUpdateRequest.Initiator(newRefState)).resultFuture.getOrThrow()
