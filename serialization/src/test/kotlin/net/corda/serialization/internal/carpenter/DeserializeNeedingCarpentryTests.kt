...
class DeserializeNeedingCarpentryTests : AmqpCarpenterBase(AllWhitelist) {
    ...
    fun simpleTypeKnownInterface() {
        val clazz = ClassCarpenterImpl(whitelist = AllWhitelist).build(ClassSchema(
                ...
                interfaces = listOf(HasName::class.java)))
        ...
        assertTrue(deserializedObj is HasName)
        assertEquals(testVal, (deserializedObj as HasName).getName())
    }
    ...
    fun arrayOfTypes() {
        ...
        val deserializedObj = DeserializationInput(sf2)
                .deserialize(TestSerializationOutput(VERBOSE, sf1).serialize(outer))
    ...
    fun unknownInterface() {
        ...
        val concreteClass = cc.build(ClassSchema(testName(), mapOf(
                ...
                interfaces = listOf(HasName::class.java, interfaceClass)))
        ...
        assertTrue(deserializedObj is HasName)
        assertEquals("timmy", (deserializedObj as HasName).getName())
