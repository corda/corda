...
class AttachmentsClassLoaderTests {
    ...
    private val cordappProvider = CordappProviderImpl(JarScanningCordappLoader.fromJarUrls(listOf(ISOLATED_CONTRACTS_JAR_PATH), 4), MockCordappConfigProvider(), attachments).apply {
