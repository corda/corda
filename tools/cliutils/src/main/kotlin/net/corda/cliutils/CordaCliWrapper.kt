...
abstract class CordaCliWrapper(alias: String, description: String) : CliWrapperBase(alias, description) {
    ...
    val cmd by lazy {
        CommandLine(this).apply {
            ...
            executionExceptionHandler = IExecutionExceptionHandler { ex: Exception, _: CommandLine, _: ParseResult ->
            ...
            executionStrategy = IExecutionStrategy { parseResult: ParseResult ->
                initLogging()
