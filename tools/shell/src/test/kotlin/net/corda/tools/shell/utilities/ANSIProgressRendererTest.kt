...
class ANSIProgressRendererTest {
    ...
    companion object {
        ...
        private val STEP_2_SKIPPED_OUTPUT = if (SystemUtils.IS_OS_WINDOWS) """  $INTENSITY_FAINT_ON_ASCII$STEP_2_LABEL$INTENSITY_OFF_ASCII""" else """  $INTENSITY_FAINT_ON_ASCII$STEP_2_LABEL$INTENSITY_OFF_ASCII"""
