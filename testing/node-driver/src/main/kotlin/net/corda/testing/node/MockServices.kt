...
open class MockServices private constructor(
    ...
    private val cordappTelemetryComponents: MutableClassToInstanceMap<TelemetryComponent> = MutableClassToInstanceMap.create<TelemetryComponent>()
     ...
     * extend [VerifyingServiceHub] would leak internal APIs. Instead we have this private view class and have the `asVerifying` extension
     * method return it.
     */
    ...
    private class VerifyingView(private val mockServices: MockServices) : VerifyingServiceHub, ServiceHub by mockServices {
        ...
        override fun isAttachmentTrusted(attachment: Attachment): Boolean {
            return attachmentTrustCalculator.calculate(attachment)
        }

        override fun loadState(stateRef: StateRef): TransactionState<*> = super.loadState(stateRef)
        override fun loadStates(stateRefs: Set<StateRef>) = super.loadStates(stateRefs)
    }
