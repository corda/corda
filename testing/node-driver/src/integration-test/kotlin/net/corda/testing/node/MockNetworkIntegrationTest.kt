...
class MockNetworkIntegrationTest {
    companion object {
        @JvmStatic
    ...
    fun `does not leak non-daemon threads`() {
        ...
        assertEquals(0, startJavaProcess<MockNetworkIntegrationTest>(emptyList(), extraJvmArguments = listOf("-javaagent:$quasar")).waitFor())
    }
}
