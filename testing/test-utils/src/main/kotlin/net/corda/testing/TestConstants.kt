...
val DUMMY_BANK_A: Party get() = Party(CordaX500Name(O = "Bank A", L = "London", C = "GB"), DUMMY_BANK_A_KEY.public)

val DUMMY_BANK_B_KEY: KeyPair by lazy { entropyToKeyPair(BigInteger.valueOf(50)) }
/** Dummy bank identity for tests and simulations */
val DUMMY_BANK_B: Party get() = Party(CordaX500Name(O = "Bank B", L = "New York", C = "US"), DUMMY_BANK_B_KEY.public)

val DUMMY_BANK_C_KEY: KeyPair by lazy { entropyToKeyPair(BigInteger.valueOf(60)) }
/** Dummy bank identity for tests and simulations */
val DUMMY_BANK_C: Party get() = Party(CordaX500Name(O = "Bank C", L = "Tokyo", C = "JP"), DUMMY_BANK_C_KEY.public)
...
val ALICE: Party get() = Party(CordaX500Name(O = "Alice Corp", L = "Madrid", C = "ES"), ALICE_KEY.public)
...
val BOB: Party get() = Party(CordaX500Name(O = "Bob Plc", L = "Rome", C = "IT"), BOB_KEY.public)
...
val CHARLIE: Party get() = Party(CordaX500Name(O = "Charlie Ltd", L = "Athens", C = "GR"), CHARLIE_KEY.public)
...
val DUMMY_PARTY: Party get() = Party(CordaX500Name(O = "Dummy", L = "Madrid", C = "ES"), DUMMY_KEY_1.public)
