...
java -Djava.security.egd=file:/dev/./urandom -Dcapsule.jvm.args="${JVM_ARGS}" -jar /opt/corda/bin/corda-firewall.jar -b=/opt/corda --config-file=/etc/corda/firewall.conf