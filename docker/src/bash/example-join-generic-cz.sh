...
docker run -ti --net="host" \
        ...
        entdocker.corda.r3cev.com/corda-utils-4.0-snapshot:latest config-generator --generic
...
docker run -ti \
        ...
        entdocker.corda.r3cev.com/corda-utils-4.0-snapshot:latest db-migrate-execute-migration
