...
./generate_from_template.py -o ${SCRIPT_DIR}/r3-corda-hot-cold/3.2 -t templates/r3-corda-hot-cold/3.2 -v '{"name":"hot-cold", "legal_name":"O=HotCold,L=London,C=GB", "image":"haregistry.azurecr.io/r3-corda:3.2"}'
