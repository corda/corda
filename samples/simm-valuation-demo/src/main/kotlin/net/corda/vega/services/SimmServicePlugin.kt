...
/**
 * [SimmServicePlugin] is the object that makes available the flows and services for the Simm agreement / evaluation flow
 ...
 */
class SimmServicePlugin : CordaPluginRegistry() {
    ...
    override fun initialise(serviceHub: PluginServiceHub) {
        serviceHub.registerFlowInitiator(SimmFlow.Requester::class.java, SimmFlow::Receiver)
        serviceHub.registerFlowInitiator(IRSTradeFlow.Requester::class.java, IRSTradeFlow::Receiver)
    }
}
