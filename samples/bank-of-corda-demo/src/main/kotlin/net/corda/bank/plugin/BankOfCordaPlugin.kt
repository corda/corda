...
class BankOfCordaPlugin : CordaPluginRegistry() {
    ...
    override val requiredFlows: Map<String, Set<String>> =
        mapOf(IssuerFlow.IssuanceRequester::class.java.name to setOf(Amount::class.java.name, Party.Full::class.java.name, OpaqueBytes::class.java.name, Party::class.java.name)
    )
