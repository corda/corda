...
internal object LinkedHashMapIteratorSerializer : Serializer<Iterator<*>>() {
    ...
    private val outerMapField: Field = DUMMY_MAP.iterator()::class.java.superclass.getDeclaredField("this$0").apply { isAccessible = true }
    private val currentField: Field = DUMMY_MAP.iterator()::class.java.superclass.getDeclaredField("current").apply { isAccessible = true }
