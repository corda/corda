...
class CryptoServiceFactory {
    companion object {
        fun makeCryptoService(cryptoServiceName: SupportedCryptoServices, legalName: CordaX500Name, signingCertificateStore: FileBasedCertificateStoreSupplier? = null, timeout: Duration? = null): CryptoService {
            ...
            return BCCryptoService(legalName.x500Principal, signingCertificateStore, timeout)
        }
    }
}