...
class SSLHelperTest {
	...
	fun `ensure SNI header in correct format`() {
        ...
        trustManagerFactory.init(initialiseTrustStoreAndEnableCrlChecking(
                CertificateStore.fromFile(trustStore.path, trustStore.storePassword, trustStore.entryPassword, false),
                false.toRevocationConfig()))
