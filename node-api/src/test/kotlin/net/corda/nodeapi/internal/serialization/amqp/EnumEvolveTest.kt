...
class EnumEvolveTest {
    ...
    fun deserialiseNewerSetToUnknown2() {
        ...
        val path1 = EvolvabilityTest::class.java.getResource("$resource.C")
        val path2 = EvolvabilityTest::class.java.getResource("$resource.D")
        val path3 = EvolvabilityTest::class.java.getResource("$resource.E")
    ...
    fun deserializeWithRename() {
        ...
        //
        val path1_AA = EvolvabilityTest::class.java.getResource("$resource.1.AA")
        val path1_B = EvolvabilityTest::class.java.getResource("$resource.1.B")
        val path1_C = EvolvabilityTest::class.java.getResource("$resource.1.C")
        ...
        //
        val path2_AA = EvolvabilityTest::class.java.getResource("$resource.2.AA")
        val path2_BB = EvolvabilityTest::class.java.getResource("$resource.2.BB")
        val path2_C = EvolvabilityTest::class.java.getResource("$resource.2.C")
        ...
        //
        val path3_AA = EvolvabilityTest::class.java.getResource("$resource.3.AA")
        val path3_XX = EvolvabilityTest::class.java.getResource("$resource.3.XX")
        val path3_C = EvolvabilityTest::class.java.getResource("$resource.3.C")
    ...
    fun multiOperations() {
        ...
        fun load(l: List<Pair<String, MultiOperations>>) = l.map {
            Pair(DeserializationInput(sf).deserialize(SerializedBytes<C>(
                    File(EvolvabilityTest::class.java.getResource(it.first).toURI()).readBytes())), it.second)
        }
    ...
    fun changedOrdinality() {
        ...
        Assertions.assertThatThrownBy {
            DeserializationInput(sf).deserialize(SerializedBytes<C>(
                    File(EvolvabilityTest::class.java.getResource(resource).toURI()).readBytes()))
        }.isInstanceOf(NotSerializableException::class.java)
    }
}
