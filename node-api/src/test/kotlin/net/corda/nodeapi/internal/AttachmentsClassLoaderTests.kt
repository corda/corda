...
class AttachmentsClassLoaderTests {
    ...
    private val cordappProvider = CordappProviderImpl(CordappLoader.createDevMode(listOf(ISOLATED_CONTRACTS_JAR_PATH)), attachments, testNetworkParameters(emptyList()))
