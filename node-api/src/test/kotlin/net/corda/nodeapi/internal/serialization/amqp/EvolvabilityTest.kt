...
class EvolvabilityTest {
    ...
    fun simpleOrderSwapSameType() {
        ...
        val resource = "EvolvabilityTest.simpleOrderSwapSameType"
        ...
        val path = EvolvabilityTest::class.java.getResource(resource)
    ...
    fun simpleOrderSwapDifferentType() {
        ...
        val A = 1
        val B = "two"
        val resource = "EvolvabilityTest.simpleOrderSwapDifferentType"
    ...
    fun addAdditionalParamNotMandatory() {
        val sf = testDefaultFactory()
        val A = 1
        val resource = "EvolvabilityTest.addAdditionalParamNotMandatory"
    ...
    fun removeParameters() {
        val sf = testDefaultFactory()
        val resource = "EvolvabilityTest.removeParameters"
        val A = 1
        val B = "two"
        val C = "three"
        val D = 4
    ...
    fun addAndRemoveParameters() {
        ...
        val resource = "EvolvabilityTest.addAndRemoveParameters"
    ...
    fun addMandatoryFieldWithAltConstructor() {
        val sf = testDefaultFactory()
        val A = 1
        val resource = "EvolvabilityTest.addMandatoryFieldWithAltConstructor"
    ...
    fun addMandatoryFieldWithAltConstructorUnAnnotated() {
        val sf = testDefaultFactory()
        val path = EvolvabilityTest::class.java.getResource(
                "EvolvabilityTest.addMandatoryFieldWithAltConstructorUnAnnotated")
        val f = File(path.toURI())
        @Suppress("UNUSED_VARIABLE")
        val A = 1
    ...
    fun addMandatoryFieldWithAltReorderedConstructor() {
        val sf = testDefaultFactory()
        val resource = "EvolvabilityTest.addMandatoryFieldWithAltReorderedConstructor"
        val A = 1
        val B = 100
    ...
    fun addMandatoryFieldWithAltReorderedConstructorAndRemoval() {
        val sf = testDefaultFactory()
        val resource = "EvolvabilityTest.addMandatoryFieldWithAltReorderedConstructorAndRemoval"
        val A = 1
        @Suppress("UNUSED_VARIABLE")
        val B = 100
        val C = "This is not a banana"
    ...
    fun multiVersion() {
        val sf = testDefaultFactory()
        val resource1 = "EvolvabilityTest.multiVersion.1"
        val resource2 = "EvolvabilityTest.multiVersion.2"
        val resource3 = "EvolvabilityTest.multiVersion.3"
        ...
        val path1 = EvolvabilityTest::class.java.getResource(resource1)
        val path2 = EvolvabilityTest::class.java.getResource(resource2)
        val path3 = EvolvabilityTest::class.java.getResource(resource3)
    ...
    fun changeSubType() {
        val sf = testDefaultFactory()
        val resource = "EvolvabilityTest.changeSubType"
        val oa = 100
        val ia = 200
    ...
    fun multiVersionWithRemoval() {
        ...
        val resource1 = "EvolvabilityTest.multiVersionWithRemoval.1"
        val resource2 = "EvolvabilityTest.multiVersionWithRemoval.2"
        val resource3 = "EvolvabilityTest.multiVersionWithRemoval.3"
