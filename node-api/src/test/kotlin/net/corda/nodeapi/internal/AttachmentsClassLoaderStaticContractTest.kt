...
class AttachmentsClassLoaderStaticContractTest {
    ...
    class AttachmentDummyContract : Contract {
        companion object {
            private val ATTACHMENT_PROGRAM_ID = "net.corda.nodeapi.internal.AttachmentsClassLoaderStaticContractTest\$AttachmentDummyContract"
        }
    ...
    fun `verify that contract DummyContract is in classPath`() {
        val contractClass = Class.forName("net.corda.nodeapi.internal.AttachmentsClassLoaderStaticContractTest\$AttachmentDummyContract")
