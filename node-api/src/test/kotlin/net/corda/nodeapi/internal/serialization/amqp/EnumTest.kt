...
class EnumTest {
    ...
    fun enumWhitelisted() {
        ...
        class WL : ClassWhitelist {
            override fun hasListed(type: Class<*>): Boolean {
                return type.name == "net.corda.nodeapi.internal.serialization.amqp.EnumTest\$enumWhitelisted\$C" ||
                        type.name == "net.corda.nodeapi.internal.serialization.amqp.EnumTest\$Bras"
            }
        }
    ...
    fun deserializeNonWhitlistedEnum() {
        ...
        val factory = SerializerFactory(WL(listOf(classTestName("C"),
                "net.corda.nodeapi.internal.serialization.amqp.EnumTest\$Bras")),
