...
public final class LambdaRPCClientSerializationTest extends TestDependencyInjectionBase {
    ...
    public void setup() {
        ...
        context = new SerializationContextImpl(SerializationSchemeKt.getKryoHeaderV0_1(), this.getClass().getClassLoader(), AllWhitelist.INSTANCE, Maps.newHashMap(), true, SerializationContext.UseCase.RPCClient);
    }
