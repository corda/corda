...
.. code-block:: shell
    ...
    docker run -ti \
            ...
            -p 10200:10200 \
            -p 10201:10201 \
            corda/corda-zulu-java1.8-|stable_corda_version|:latest
...
.. code-block:: shell
    ...
    docker run -ti \
            ...
            corda/corda-zulu-java1.8-|stable_corda_version|:latest config-generator --testnet
...
.. code-block:: shell
    ...
    docker run -ti --net="host" \
            ...
            -v /home/user/docker/config:/etc/corda          \
            -v /home/user/docker/certificates:/opt/corda/certificates \
            corda/corda-zulu-java1.8-|stable_corda_version|:latest config-generator --generic
