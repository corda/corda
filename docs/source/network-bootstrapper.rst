...
``java -jar network-bootstrapper-|stable_corda_version|.jar --dir <nodes-root-dir>``
...
``java -jar network-bootstrapper-|stable_corda_version|.jar --network-parameter-overrides=<path_to_file>``

Or alternatively, by using the short form version:

``java -jar network-bootstrapper-|stable_corda_version|.jar -n=<path_to_file>``
