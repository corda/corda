...
1. Generate a nonce value to form a challenge to the other nodes, in order to ensure their responses are specific to
   this request and are not replayed from another node.
