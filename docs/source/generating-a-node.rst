...
* The Corda JAR, downloaded from https://r3.bintray.com/corda/net/corda/corda/ (under /|stable_corda_version|/corda-|stable_corda_version|.jar)
...
* **Optional:** A webserver JAR entitled ``corda-webserver-|stable_corda_version|.jar`` that will connect to the node via RPC
